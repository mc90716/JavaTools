...
public class HotThreads {
    ...
    private long threadElementsSnapshotDelay = 10;
    ...
    public HotThreads threadElementsSnapshotDelay(long threadElementsSnapshotDelay) {
    ...
    private String innerDetect() throws Exception {
        ...
        sb.append(DATE_TIME_FORMATTER.format(new Date(System.currentTimeMillis())));
        sb.append(", interval=");
        ...
        try {
            ...
            for (int t = 0; t < busiestThreads; t++) {
                ...
                double percent = (((double) time) / intervalMs * 1000000) * 100;
                sb.append(String.format(Locale.ROOT, "%n%4.1f%% (%s out of %s) %s usage by thread '%s'%n", percent, time, intervalMs, type, threadName));
